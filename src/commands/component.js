...
function task(args, options) {
  ...
  try {
    const { files, componentName, componentPath } = generateComponent(component);
    logger.info(
...
function register(program) {
  program
    ...
    .option('-c, --css-extension [extension]', 'Change the style type (default: scss)')
    .option('-d, --directory [dir]', 'Specify component directory (default: src/shared/components)')
